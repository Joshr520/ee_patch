...
#define NOTIF_EXLUDE(str_name) array_override::exclude_from_notif(str_name)
#define REMOVE_NOTIF_EXCLUDE(str_name) array_override::remove_exlude_from_notif(str_name)
...
#define ADD_RECURSIVE_FLAG(str_name,n_type,a_flags) array_override::add_recursive_override_flag(str_name,n_type,a_flags)
